...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 flex items-center px-6 md:px-10 py-4 transition-all duration-500 shadow-md ${
        isScrolled ? "bg-white text-[#2b210a]" : "bg-[#2b210a] text-white"
      }`}
    >
      {/* Logo kiri */}
        ...
        <AnimatePresence>
          {!searchOpen && (
            ...
            >
              ...
              <a href="#coffeeshop" className="hover:text-yellow-600 transition-colors duration-300">
                Coffeeshop
              </a>
              <a href="#" className="hover:text-yellow-600 transition-colors duration-300">
                Artikel
      ...
      <div className="flex items-center gap-3 md:gap-4 relative">
        <div className="relative flex items-center">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  >
                    ...
                    {/* Tombol Search di dalam searchbar */}
                    <motion.div
          ...
          {/* Tombol Search utama (muncul hanya saat tertutup) */}
          {!searchOpen && (
            <motion.div className="relative">
                ...
                {searchOpen && (
                  <motion.div
                    ...
                    className={`absolute inset-0 rounded-full ${
                      isScrolled ? "bg-white/20" : "bg-[#2b210a]/20"
                    }`}
                  />
                )}
              </AnimatePresence>
              ...
              <motion.button
                ...
                className={`p-3 rounded-full transition z-40 ${
                  isScrolled

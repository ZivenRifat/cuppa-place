...
const { User, Cafe, Menu, Review, Favorite, CafePhoto } = db;
...
// Cafe - CafePhoto association
if (Cafe && CafePhoto) {
  Cafe.hasMany(CafePhoto, { foreignKey: 'cafe_id', as: 'photos' });
  CafePhoto.belongsTo(Cafe, { foreignKey: 'cafe_id', as: 'cafe' });
}
